                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('distribuidors.show', $registro) }}" class="btn btn-primary btn-sm">Detalhes</a>
                                    <a href="{{ route('distribuidors.edit', $registro) }}" class="btn btn-danger btn-sm">Atualizar</a>
                                </td>
                            </tr>
                            @empty
                            <tr>
