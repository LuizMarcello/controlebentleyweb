...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('notafiscal', @$antena->notafiscal) }}" type="text" id="notafiscal" name="notafiscal" required="required"
            maxlength="18" class="notafiscal form-control @error('banda') is-invalid @enderror">
        @error('notafiscal')
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('datanota', @$antena->datanota) }}" type="text" id="datanota" name="datanota" required="required"
            maxlength="18" class="datanota form-control @error('banda') is-invalid @enderror">
        @error('datanota')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('banda', @$antena->banda) }}" type="text" id="banda" name="banda" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('marca', @$antena->marca) }}" type="text" id="marca" name="marca" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('modelo', @$antena->modelo) }}" type="text" id="modelo" name="modelo" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('diametro', @$antena->diametro) }}" type="text" id="diametro" name="diametro" {{-- required="required" --}}
            maxlength="18" class="diametro form-control @error('diametro') is-invalid @enderror">
        @error('diametro')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('observacao', @$antena->observacao) }}" type="text" id="observacao" name="observacao" maxlength="500"
