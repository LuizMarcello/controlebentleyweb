...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('notafiscal', @$tria->notafiscal) }}" type="text" id="notafiscal" name="notafiscal" required="required" maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('banda', @$tria->banda) }}" type="text" id="banda" name="banda" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('marca', @$tria->marca) }}" type="text" id="marca" name="marca" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('modelo', @$tria->modelo) }}" type="text" id="modelo" name="modelo" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('serial', @$tria->serial) }}" type="text" id="serial" name="serial" {{-- required="required" --}} maxlength="18"
