            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Listagem de trias</h3>
                        <div class="card-tools">
                            <a href="{{ route('trias.create') }}" class="btn btn-success">Nova
                                Tria</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($registros as $registro)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('trias.show', $registro) }}"
                                                class="btn btn-primary btn-sm">Detalhes</a>
                                            <a href="{{ route('trias.edit', $registro) }}"
