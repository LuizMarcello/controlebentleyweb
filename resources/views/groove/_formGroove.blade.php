...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('notafiscal', @$groove->notafiscal) }}" type="text" id="notafiscal" name="notafiscal" required="required" maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('datanota', @$groove->datanota) }}" type="text" id="banda" name="banda" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('marca', @$groove->marca) }}" type="text" id="marca" name="marca" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('modelo', @$groove->modelo) }}" type="text" id="modelo" name="modelo" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('serial', @$groove->serial) }}" type="text" id="serial" name="serial" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('observacao', @$groove->observacao) }}" type="text" id="observacao" name="observacao" maxlength="500"
