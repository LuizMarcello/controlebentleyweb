...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('nome') }}" type="text" id="nome" name="nome" required="required" maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('cir') }}" type="text" id="cir" name="cir" required="required" maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('velocmaxdown') }}" type="text" id="velocmaxdown" name="velocmaxdown" required="required" maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('velocmaxup') }}" type="text" id="velocmaxup" name="velocmaxup" required="required" maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('velocmindown') }}" type="text" id="velocmindown" name="velocmindown" required="required" maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('velocminup') }}" type="text" id="velocminup" name="velocminup" required="required" maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('equipamento') }}" type="text" id="equipamento" name="equipamento" required="required" maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('valordecusto') }}" type="text" id="valordecusto" name="valordecusto" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('valormensal') }}" type="text" id="valormensal" name="valormensal" required="required" maxlength="18"
