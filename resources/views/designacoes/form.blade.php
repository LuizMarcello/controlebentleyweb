    ...
    {{-- <style type="text/css">
        .divModem {display:none; }
    </style>

    <style type="text/css">
        .divAntena {display:none; }
    </style> --}}
    ...
    <div class="form-group row divModem {{ $errors->has('modem') ? 'has-error' : '' }}">
    ...
    <div class="form-group row divAntena{{ $errors->has('antena') ? 'has-error' : '' }}">
