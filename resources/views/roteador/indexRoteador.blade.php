            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Listagem de Roteadores</h3>
                        <div class="card-tools">
                            <a href="{{ route('roteadors.create') }}" class="btn btn-success">Novo
                                Roteador</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($registros as $registro)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('roteadors.show', $registro) }}"
                                                class="btn btn-primary btn-sm">Detalhes</a>
                                            <a href="{{ route('roteadors.edit', $registro) }}"
