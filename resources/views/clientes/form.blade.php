...
<div class="form-group {{ $errors->has('nome_razaosocial') ? 'has-error' : ''}}">
    ...
    <input class="form-control" rows="5" name="nome_razaosocial" type="text" id="nome_razaosocial" required value="{{ old('nome_razaosocial', @$cliente->nome_razaosocial) }}">
...
<div class="form-group {{ $errors->has('ie_rg') ? 'has-error' : ''}}">
    ...
    <input class="ie_rg form-control" name="ie_rg" type="text" id="ie_rg" value="{{ isset($cliente->ie_rg) ? $cliente->ie_rg : ''}}" >
...
<div class="form-group {{ $errors->has('documento') ? 'has-error' : ''}}">
   ...
   {{--  <input class="documento form-control" name="documento" type="text" id="documento" value="{{ isset($cliente->documento) ? $cliente->documento : ''}}" required> --}}
    <input class="documento form-control" name="documento" type="text" id="documento" value="{{ old('documento', @$cliente->documento) }}" required>
...
<div class="form-group {{ $errors->has('dataadesao') ? 'has-error' : ''}}">
    ...
    <input class="datanota form-control" name="dataadesao" type="text" id="dataadesao" value="{{ old('dataadesao', @$cliente->dataadesao) }}" required>
...
<div class="form-group {{ $errors->has('inscricaomunicipal') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="inscricaomunicipal" type="text" id="inscricaomunicipal" value="{{ old('inscricaomunicipal', @$cliente->inscricaomunicipal) }}" >
...
<div class="form-group {{ $errors->has('datanascimento') ? 'has-error' : ''}}">
    ...
    <input class="datanota form-control" name="datanascimento" type="text" id="datanascimento" value="{{ old('datanascimento', @$cliente->datanascimento) }}" >
...
<div class="form-group {{ $errors->has('nome_contato') ? 'has-error' : ''}}">
   ...
   {{--  <input class="form-control" rows="5" name="nome_contato" type="textarea" id="nome_contato" value="{{isset($cliente->nome_contato) ? $cliente->nome_contato : ''}}"> --}}
    <input class="form-control" rows="5" name="nome_contato" type="textarea" id="nome_contato" value="{{ old('nome_contato', @$cliente->nome_contato) }}">
...
<div class="form-group {{ $errors->has('celular1') ? 'has-error' : ''}}">
    ...
    <input class="celular form-control" name="celular1" type="text" id="celular1" value="{{ old('celular1', @$cliente->celular1) }}" required>
...
<div class="form-group {{ $errors->has('celular2') ? 'has-error' : ''}}">
    ...
    <input class="celular form-control" name="celular2" type="text" id="celular2" value="{{ old('celular2', @$cliente->celular2) }}" >
...
<div class="form-group {{ $errors->has('telefone1') ? 'has-error' : ''}}">
   ...
   {{--  <input class="phone form-control" name="telefone1" type="text" id="telefone1" value="{{ isset($cliente->telefone1) ? $cliente->telefone1 : ''}}" required> --}}
    <input class="phone form-control" name="telefone1" type="text" id="telefone1" value="{{ old('telefone1', @$cliente->telefone1) }}" required>
...
<div class="form-group {{ $errors->has('telefone2') ? 'has-error' : ''}}">
   ...
   {{--  <input class="phone form-control" name="telefone2" type="text" id="telefone2" value="{{ isset($cliente->telefone2) ? $cliente->telefone2 : ''}}" > --}}
    <input class="phone form-control" name="telefone2" type="text" id="telefone2" value="{{ old('telefone2', @$cliente->telefone2 )}}" >
...
<div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="email" type="text" id="email" value="{{ old('email', @$cliente->email)}}" required>
...
<div class="form-group {{ $errors->has('equipamento') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="equipamento" type="text" id="equipamento" value="{{ old('equipamento', @$cliente->equipamento) }}" >
...
<div class="form-group {{ $errors->has('cep1') ? 'has-error' : ''}}">
   ...
   {{--  <input class="cep form-control" name="cep1" type="text" id="cep1" requered value="{{ isset($cliente->cep1) ? $cliente->cep1 : ''}}" > --}}
    <input class="cep form-control" name="cep1" type="text" id="cep1" requered value="{{ old('cep1', @$cliente->cep1) }}" >
...
<div class="form-group {{ $errors->has('rua1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" rows="5" name="rua1" type="text" id="rua1" requered value="{{ old('rua1', @$cliente->rua1) }}">
...
<div class="form-group {{ $errors->has('numero1') ? 'has-error' : ''}}">
   ...
   {{--  <input class="form-control" name="numero1" type="text" id="numero1" requered value="{{ isset($cliente->numero1) ? $cliente->numero1 : ''}}" > --}}
    <input class="form-control" name="numero1" type="text" id="numero1" requered value="{{ old('numero1', @$cliente->numero1) }}" >
...
<div class="form-group {{ $errors->has('bairro1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bairro1" type="text" id="bairro1" value="{{ old('bairro1', @$cliente->bairro1) }}" >
...
<div class="form-group {{ $errors->has('cidade1') ? 'has-error' : ''}}">
   ...
   {{--  <input class="form-control" name="cidade1" type="text" id="cidade1" requered value="{{ isset($cliente->cidade1) ? $cliente->cidade1 : ''}}" > --}}
    <input class="form-control" name="cidade1" type="text" id="cidade1" requered value="{{ old('cidade1', @$cliente->cidade1) }}" >
...
<div class="form-group {{ $errors->has('celular11') ? 'has-error' : ''}}">
    ...
    <input class="celular form-control" name="celular11" type="text" id="celular11" value="{{ old('celular11', @$cliente->celular11) }}" >
...
<div class="form-group {{ $errors->has('telefone11') ? 'has-error' : ''}}">
    ...
    <input class="phone form-control" name="telefone11" type="text" id="telefone11" value="{{ old('telefone11', @$cliente->telefone11) }}" >
...
<div class="form-group {{ $errors->has('rua2') ? 'has-error' : ''}}">
   ...
   {{--  <input class="form-control" rows="5" name="rua2" type="text" id="rua2" value="{{ isset($cliente->rua2) ? $cliente->rua2 : ''}}" > --}}
    <input class="form-control" rows="5" name="rua2" type="text" id="rua2" value="{{ old('rua2', @$cliente->rua2) }}" >
...
<div class="form-group {{ $errors->has('numero2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="numero2" type="text" id="numero2" value="{{ old('numero2', @$cliente->numero2) }}" >
...
<div class="form-group {{ $errors->has('bairro2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bairro2" type="text" id="bairro2" value="{{ old('bairro2', @$cliente->bairro2) }}" >
...
<div class="form-group {{ $errors->has('cidade2') ? 'has-error' : ''}}">
   ...
   {{--  <input class="form-control" name="cidade2" type="text" id="cidade2" value="{{ isset($cliente->cidade2) ? $cliente->cidade2 : ''}}" > --}}
    <input class="form-control" name="cidade2" type="text" id="cidade2" value="{{ old('cidade2', @$cliente->estado2) }}" >
...
<div class="form-group {{ $errors->has('estado2') ? 'has-error' : ''}}">
   ...
   {{--  <input class="form-control" name="estado2" type="text" id="estado2" value="{{ isset($cliente->estado2) ? $cliente->estado2 : ''}}" > --}}
    <input class="form-control" name="estado2" type="text" id="estado2" value="{{ old('estado2', @$cliente->estado2) }}" >
...
<div class="form-group {{ $errors->has('celular21') ? 'has-error' : ''}}">
   ...
   {{--  <input class="celular form-control" name="celular21" type="text" id="celular21" value="{{ isset($cliente->celular21) ? $cliente->celular21 : ''}}" > --}}
    <input class="celular form-control" name="celular21" type="text" id="celular21" value="{{ old('celular21', @$cliente->celular21) }}" >
...
<div class="form-group {{ $errors->has('telefone21') ? 'has-error' : ''}}">
   ...
   {{--  <input class="phone form-control" name="telefone21" type="text" id="telefone21" value="{{ isset($cliente->telefone21) ? $cliente->telefone21 : ''}}" > --}}
    <input class="phone form-control" name="telefone21" type="text" id="telefone21" value="{{ old('telefone21', @$cliente->telefone21) }}" >
...
<div class="form-group {{ $errors->has('rua3') ? 'has-error' : ''}}">
    ...
    <input class="form-control" rows="5" name="rua3" type="text" id="rua3" value="{{ old('rua3', @$cliente->rua3) }}">
...
<div class="form-group {{ $errors->has('numero3') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="numero3" type="text" id="numero3" value="{{ old('numero3', @$cliente->numero3) }}" >
...
<div class="form-group {{ $errors->has('bairro3') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bairro3" type="text" id="bairro3" value="{{ old('bairro3', @$cliente->bairro3) }}" >
...
<div class="form-group {{ $errors->has('cidade3') ? 'has-error' : ''}}">
   ...
   {{--  <input class="form-control" name="cidade3" type="text" id="cidade3" value="{{ isset($cliente->cidade3) ? $cliente->cidade3 : ''}}" > --}}
    <input class="form-control" name="cidade3" type="text" id="cidade3" value="{{ old('cidade3', @$cliente->cidade3) }}" >
...
<div class="form-group {{ $errors->has('estado3') ? 'has-error' : ''}}">
   ...
   {{--  <input class="form-control" name="estado3" type="text" id="estado3" value="{{ isset($cliente->estado3) ? $cliente->estado3 : ''}}" > --}}
    <input class="form-control" name="estado3" type="text" id="estado3" value="{{ old('estado3', @$cliente->estado3) }}" >
...
<div class="form-group {{ $errors->has('celular31') ? 'has-error' : ''}}">
    ...
    <input class="celular form-control" name="celular31" type="text" id="celular31" value="{{ old('celular31', @$cliente->celular31) }}" >
...
<div class="form-group {{ $errors->has('telefone31') ? 'has-error' : ''}}">
    ...
    <input class="phone form-control" name="telefone31" type="text" id="telefone31" value="{{ old('telefone31', @$cliente->telefone31) }}" >
