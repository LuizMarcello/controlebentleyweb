            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Listagem de Ilnbs</h3>
                        <div class="card-tools">
                            <a href="{{ route('ilnbs.create') }}" class="btn btn-success">Novo
                                Ilnb</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($registros as $registro)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('ilnbs.show', $registro) }}"
                                                class="btn btn-primary btn-sm">Detalhes</a>
                                            <a href="{{ route('ilnbs.edit', $registro) }}"
