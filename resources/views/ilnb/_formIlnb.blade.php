...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('') }}" type="text" id="notafiscal" name="notafiscal" required="required" maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('') }}" type="text" id="datanota" name="datanota" required="required" maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('') }}" type="text" id="banda" name="banda" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('') }}" type="text" id="marca" name="marca" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('') }}" type="text" id="modelo" name="modelo" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('') }}" type="text" id="serial" name="serial" {{-- required="required" --}} maxlength="18"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('') }}" type="text" id="observacao" name="observacao" maxlength="500"
