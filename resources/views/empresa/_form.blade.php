...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('razao_social', @$empresa->razao_social) }}" type="text" id="razao_social"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('documento', @$empresa->documento) }}" type="text" id="documento" name="documento"
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('ie_rg', @$empresa->ie_rg) }}" type="text" id="ie_rg" name="ie_rg" maxlength="12"
...
<div id="cliente">
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input value="{{ old('nome_contato', @$empresa->nome_contato) }}" type="text" id="nome_contato"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input value="{{ old('telefone', @$empresa->telefone) }}" type="text" id="telefone" name="telefone"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input value="{{ old('numero', @$empresa->numero) }}" type="text" id="numero" name="numero"
