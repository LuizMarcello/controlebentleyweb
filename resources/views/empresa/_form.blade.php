...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('documento', @$empresa->documento) }}" type="text" id="documento" name="documento" required="required" maxlength="18" class="documento form-control @error('documento') is-invalid @enderror">
        @error('documento')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('rua', @$empresa->rua) }}" type="text" id="rua" name="rua" maxlength="150" class="form-control @error('rua') is-invalid @enderror">
        @error('rua')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ old('numero', @$empresa->numero) }}" type="text" id="numero" name="numero" maxlength="150" class="form-control @error('numero') is-invalid @enderror">
        @error('numero')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
