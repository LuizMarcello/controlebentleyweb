window.onload = function() {
    var cep = document.getElementById('cepempr');
...
function autoComplete(cep) {
    ...
    fetch(url).then(function(response) {
            ...
            response.json().then(function(endereco) {
                ...
                document.getElementById('ruaempr').value = endereco.endereco;
                document.getElementById('bairroempr').value = endereco.bairro;
                document.getElementById('cidadeempr').value = endereco.cidade;
                document.getElementById('estadoempr').value = endereco.uf;
            });
        }
    });
}
